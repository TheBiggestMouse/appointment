			...
			<nav class="nav navbar-default navbar-fixed-top container-fluid" role="navigation" style="background-color:aquamarine;">
				...
				<div class="collapse navbar-collapse" id="mynav">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="../2.persenal_center/patient_personinfo.html">个人中心</a></li>
					...
					<div class="nav navbar-right">
						<ul class="nav navbar-nav">
							<li><a href="huanzhe_login.html">登录</a></li>
        		...
        		<div class="panel">
        			<div class="col-sm-12" style="margin-top: 10px;">
						<ul class="nav nav-tabs nav-stacked info_left">
							<li ><a href="javascript:info_qiehuan('adminEditPage')">个人信息</a></li>
